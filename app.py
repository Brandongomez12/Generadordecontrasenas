...
def transformar_texto(texto):
    ...
    for letra in texto:
        ...
        if letra_base == "a" and random.random() < 0.5:
            nuevo += "4"
        elif letra_base == "e" and random.random() < 0.5:
            nuevo += "3"
        elif letra_base == "i" and random.random() < 0.5:
            nuevo += "1"
        elif letra_base == "o" and random.random() < 0.5:
            nuevo += "0"
        else:
            nuevo += letra
...
with col1:
    ...
    if st.button("🔑 Generar contraseña"):
        base = transformar_texto(nombre + apellido)
        simbolos = "0123456789!@#$%^&*"
